...
for i in data:
    ...
    # trường hợp khách hàng có lịch sử thanh toán trễ
    elif (i["mentionHistory"]["evaluate"]) and (i["mentionHistory"]["decision"]) == "yes":
    ...
    # trường hợp khách hàng không có lịch sử đóng trễ
...
print(f"Kết quả recommentdation version 2 {result_recommentdation}")